...
def _equal_chinese_char(str1,str2):
    ...
    try:
        equal3 = str(str1.decode("utf-8").encode("gb2312"), encoding='unicode_escape') == str2
    except Exception as e:
        pass

    try:
        equal4 = str(str1.encode("gb2312"), encoding='unicode_escape') == str2
    except Exception as e:
        pass
...
def _in_chinese_char(str1,str2):
    ...
    try:
        equal3 = str(str1.decode("utf-8").encode("gb2312"), encoding='unicode_escape') in str2
    except Exception as e:
        pass

    try:
        equal4 = str(str1.encode("gb2312"), encoding='unicode_escape') in str2
    except Exception as e:
        pass
...
def _get_mysteel_price(
    ...
    Precondition:
        ...
        Optional:
            ...
            mode:
                mode can be either:
                "furnace_raw": get the ���� price blast furnance raw material ¯�� http://list1.mysteel.com/article/p-3571-------------1.html
                "construction": construction material ���� e.g url = "http://list1.mysteel.com/market/p-228-----010101-0-0104-------1.html"
                    in this mode, additional parameters needed as below
                        "price_name" in chinese is needed for navigating to the page with the price. e.g. "����г������ֲļ۸�����" is needed to search for the title
                        "product" in chinese e.g. "���Ƹ�"
                        "spec" ���mm��e.g.
                        "origin" �ֳ�/����" e.g. "��������"
                "hrc"/"crc": HRC ���� first page e.g. "http://list1.mysteel.com/price/p-10058--010103--1.html"
                "crc": CRC ���� first page e.g. "http://list1.mysteel.com/price/p-10053--010104--1.html"
                    area: e.g. "�Ϻ�" col
                    spec: e.g. "1.0mm" row
    Postcondition:
...
def get_mysteel_data(product_list, tday, suppress_exception = False):
    ...
    try:
        ...
        for product in product_list:
            setting = dict( list(mysteel_url_map[product].items()) + list({"suppress_exception": suppress_exception, "the_date": tday,
