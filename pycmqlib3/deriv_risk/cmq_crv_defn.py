...
COM_Curve_Map = {
    ...
    'DCECOKE': {'instID': 'j', 'exch': 'DCE', 'calendar': 'CHN', 'ccy': 'CNY', \
                'active_mths': [1, 5, 9], 'roll_rule': '-35b',
                'parent_curve': '', 'spotID': 'j', 'vol_index': 'DCECOKE',},
    'DCECOK': {'instID': 'jm', 'exch': 'DCE', 'calendar': 'CHN', 'ccy': 'CNY', \
                'active_mths': [1, 5, 9], 'roll_rule': '-35b',
                'parent_curve': '', 'spotID': 'jm', 'vol_index': 'DCECOK',},
