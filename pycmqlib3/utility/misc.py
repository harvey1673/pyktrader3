...
product_code = {'SHFE': ['cu', 'cu_Opt', 'al', 'al_Opt', 'ao', 'ao_Opt', 'zn', 'zn_Opt', 'pb', 'pb_Opt',
                ...
                'DCE': ['c', 'c_Opt', 'cs', 'cs_Opt', 'j', 'jd', 'jd_Opt', 'a', 'a_Opt', 'b', 'b_Opt',
                        ...
                        'eb', 'eb_Opt', 'pg', 'pg_Opt', 'lh', 'lh_Opt', 'lg', 'lg_Opt', 'bz', 'bz_Opt'],
                # 'ER', 'WS', 'WT',
                'CZCE': ['WH', 'PM', 'CF', 'CF_Opt', 'CY', 'SR', 'SR_Opt',
                         ...
                         'PF', 'PF_Opt', 'PK', 'PK_Opt', 'PX', 'PX_Opt', 'SH', 'SH_Opt', 'PR', 'PL', 'PL_Opt'],
                'INE': ['sc', 'sc_Opt', 'nr', 'lu', 'bc', 'ec'],
                'GFEX': ['si', 'si_Opt', 'lc', 'lc_Opt', 'ps', 'ps_Opt', 'pt', 'pt_Opt', 'pd', 'pd_Opt'],
                'SGX': ['FEF', 'M65F'],
                'LME': ['lsc', 'lsr', 'lhc'],
                'NYMEX': ['nhr', ]}
