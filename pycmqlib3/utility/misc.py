...
CHN_Holidays = [datetime.date(2014, 1, 1), datetime.date(2014, 1, 2), datetime.date(2014, 1, 3),
                ...
                datetime.date(2022, 9, 12), datetime.date(2022, 9, 21),
                datetime.date(2022, 10, 3), datetime.date(2022, 10, 4), datetime.date(2022, 10, 5),
...
product_code = {'SHFE': ['cu', 'cu_Opt', 'al', 'zn', 'pb', 'wr', 'rb', 'fu', 'ru', 'ru_Opt', \
                ...
                'CZCE': ['ER', 'RO', 'WS', 'WT', 'WH', 'PM', 'CF', 'CF_Opt', 'CY', 'SR', 'SR_Opt', \
                         'TA', 'TA_Opt', 'OI', 'RI', 'ME', 'FG', 'RS', 'RM', 'RM_Opt', 'TC', \
                         'JR', 'LR', 'MA', 'MA_Opt', 'SM', 'SF', 'ZC', 'ZC_Opt', 'AP', 'CJ', 'UR', 'SA', 'PF', 'PK'],
                'INE': ['sc', 'nr', 'lu', 'bc'],
...
def get_opt_expiry(fut_inst, cont_mth, exch=''):
    ...
    if fut_inst[:6].isdigit():
        ...
        expiry = workdays.workday(expiry, 1, CHN_Holidays)
    elif product in ['SR', 'CF', 'TA', 'MA', 'RM']:
        if cont_mth > 1:
