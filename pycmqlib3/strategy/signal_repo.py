...
signal_store = {
    ...
    'io_inv_rmv_ratio_1y': [['i'],
                            ['io_inv_removal_ratio_45p', 'hlratio', [48, 56], 'df1', 'pct_change', False, '', "", 120, [-2,2]]],
    'io_inv_rmv_spd_hlr_1y': [['i_rb', 'i_hc'],
                            ['io_inv_removal_ratio_45p', 'hlratio', [48, 56], '', '', False, '', "", 120, [-2,2]]],
