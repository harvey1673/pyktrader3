...
signal_store = {
    ...
    'al_alumina_qtl': [['al'],
                       ['alumina_aus_fob', 'qtl', [10, 20], '', '', True, 'price', "", 120]],
    'al_coal_qtl': [['al'],
                    ['zc_5500_qhd', 'qtl', [240, 250], '', '', True, 'price', "", 120]],
    'al_alumina_yoy_qtl': [['al'],
                           ['alumina_aus_fob', 'qtl', [20, 40], 'cal_yoy_day', 'pct_change', True, 'price', "", 120]],
    'al_coal_yoy_qtl': [['al'],
                        ['zc_5500_qhd', 'qtl', [20, 40], 'cal_yoy_day', 'pct_change', True, 'price', "", 120]],
    'zn_hrc_mom': [['zn'], ['hrc_sh', 'qtl', [20, 30], '', '', True, 'price', "", 120]],
    'pb_sec_margin_zs': [['pb'], ['pb_sec_margin', 'zscore', [230, 250, 2], '', '', False, 'price', "", 120]],
    'ni_ore_qtl': [['ni'], ['ni_php_1.5_cif', 'qtl', [10, 20], '', '', True, '', "", 120]],
    ...
    'sn_conc_spot_hlr': [['sn'], ['sn_60conc_spot_jiangxi', 'hlratio', [40, 80, 2], '', '', True, '', "", 120]],
    ...
    'base_tc_3y_zs': [['cu', 'pb', 'zn'], ['base_tc', 'zscore', [720, 750, 2], '', '', False, 'price', "", 120]],
