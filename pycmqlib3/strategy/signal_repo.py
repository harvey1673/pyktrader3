...
signal_store = {
    ...
    # io removal + pinv/rmv
    'io_removal_lvl': [['i'],
                       ['io_removal_45ports', 'qtl', [20, 40, 2], '', '', True, 'price', 'ema1', 120, [-2,2]]],
    'io_removal_lyoy': [['i'],
                        ['io_removal_45ports', 'qtl', [20, 40, 2], 'lunar_yoy_day', 'diff', True, 'price', 'ema1', 120, [-2,2]]],
    ...
    'io_removal_chg_lunar_hlr': [['i'],
                        ['io_removal_45ports', 'seasonal_lunar_wk_hlr', [2, 5, 10], 'df1|ema1', 'diff', True, '', '', 120, [-2,2]]],
    ...
    "iosales_lyoy_ema": [['i'],
                         ['io_trdvol_davg_majorports', 'ema', [1, 2, 1], 'lunar_yoy_day', 'diff', True, '', "", 20, [-2,2]]],
    "iosales_lunar_hr": [['i'],
                         ['io_trdvol_davg_majorports', 'seasonal_lunar_wk_hlr', [1, 4, 10], '', '', True, '', "", 20, [-2,2]]],
    "iosales_lyoy_spd_qtl": [['i_rb', 'i_hc'],
                             ['io_trdvol_davg_majorports', 'qtl', [100, 110, 1], 'lunar_yoy_day', 'diff', True, '', "", 20, [-2,2]]],
    'io_millinv_lyoy': [['hc', 'i'],
                        ['io_inv_mill(64)', 'qtl', [2, 4, 1], 'lunar_yoy_day', 'diff', True, 'W-Thu', 'ema5', 120, [-2,2]]],
    'io_minvdays_mds': [['i'],
                        ['io_invdays_mill(247)', 'ma_dff_sgn', [8, 12, 1], '', '', True, '', '', 26, [-2,2]]],
    'io_invdays_imp_mill(64)_lvl': [['i'], ['io_invdays_imp_mill(64)', 'qtl', [20, 40, 2], '', '', True, 'price', '', 120, [-2,2]]],
    "stl_dmd_spd_lunar_zs": [['hc_i', 'rb_i'],
                        ['steel_demand', 'seasonal_lunar_wk_zs', [1, 5, 10], '', '', True, '', "", 120, [-2,2]]],
    "stl_dmd_spd_cal_zs": [['hc_i', 'rb_i'],
                        ['steel_demand', 'seasonal_cal_wk_zs', [1, 5, 10], '', '', True, '', "", 120, [-2,2]]],
    ...
    'steel_stu_chg_lunar_hlr': [['rb', 'hc', 'i'],
                                ['steel_social_stockdays', 'seasonal_lunar_wk_hlr', [1, 6, 10], 'df1|ema1', 'diff', False, '', "", 120, [-2,2]]],
    ...
    'steel_total_stu_lyoy_hlr_st': [['rb', 'hc', 'i'],
                                    ['steel_social_stockdays', 'hlratio', [8, 12, 1], 'lunar_yoy_day', 'diff', False, '', "ema1", 120, [-2,2]]],
    # 'steel_total_stu_hlr_st': [['rb', 'hc', 'i'],
    #                            ['steel_social_stockdays', 'hlratio', [12, 24, 1], '', '', False, '', "ema1", 120, [-2,2]]],
    'steel_total_stu_lyoy_hlr_yr': [['rb', 'hc', 'i'],
                                    ['steel_social_stockdays', 'hlratio', [48, 56, 1], 'lunar_yoy_day', 'diff', False, '', "ema1", 120, [-2,2]]],
    'steel_total_stu_hlr_yr': [['rb', 'hc', 'i'],
                               ['steel_social_stockdays', 'hlratio', [48, 56, 1], '', '', False, '', "ema1", 120, [-2,2]]],
    ...
    # import arb
    'pbf_arb_hlr': [['rb', 'hc'], # macf jmb
                    ['pbf_import_profit', 'hlratio', [40, 60, 2], 'ema5', '', False, 'price', 'ema1', 120, [-2,2]]],
    'macf_arb_hlr': [['rb', 'hc'], # macf jmb
                    ['macf_import_profit', 'hlratio', [40, 60, 2], 'ema5', '', False, 'price', 'ema1', 120, [-2,2]]],
    'pbf_arb_spd_hlr': [['rb_i', 'hc_i'], # macf jmb
                       ['pbf_import_profit', 'hlratio', [40, 60, 2], 'ema5', '', False, 'price', 'ema1', 120, [-2,2]]],
    'macf_arb_spd_hlr': [['rb_i', 'hc_i'], # macf jmb
                        ['macf_import_profit', 'hlratio', [40, 60, 2], 'ema5', '', False, 'price', 'ema1', 120, [-2,2]]],
    ...
    'rb_phycarry_ema': [['fef', 'rb', 'i'],
                        ['rb_phycarry', 'ema', [5, 10, 1], '', '', True, '', "ema1", 120, [-2,2]]],
    'hc_phycarry_ema': [['fef', 'hc', 'i'],
                        ['hc_phycarry', 'ema', [5, 10, 1], '', '', True, '', "ema1", 120, [-2,2]]],
    ...
    'ckc_auction_rate_qtl': [['jm', 'j'],
                             ['jm_auction_rate_cn_d', 'qtl', [240, 260, 2], 'ema5', '', True, 'price', "", 120, [-2,2]]],
    'coke_dprod_lt_hlr': [['j_jm'],
                          ['coke_dprod_total', 'hlratio', [60, 100, 2], '', '', True, 'price', "", 120, [-2,2]]],
    'coke_dprod_st_qtl': [['j_jm'],
                          ['coke_dprod_total', 'qtl', [20, 40, 2], '', '', True, 'price', "", 120, [-2,2]]],
    'coke_senti_cokery_qtl': [['j', 'jm'],
                              ['coke_senti_124cokery', 'qtl', [2, 4, 1], '', '', True, '', "", 120, [-2,2]]],
    'coke_senti_mine_qtl': [['j', 'jm'],
                              ['coke_senti_38mines', 'qtl', [2, 4, 1], '', '', True, '', "", 120, [-2,2]]],
    'coke_senti_trader_qtl': [['j', 'jm'],
                              ['coke_senti_12traders', 'qtl', [2, 4, 1], '', '', True, '', "", 120, [-2,2]]],
    'ckc_mongolia_truck_cal_hlr': [['j', 'jm'],
                                   ['ckc_imports_ganqimaodu_wkly', 'seasonal_cal_wk_hlr', [1, 4, 10], '', '', False, '', "", 120, [-2,2]]],
    ...
    # FEF TS
    "fefts_leadlag_zs": [["FEFc1_FEFc4"],
                         ["FEF_tsc0", "zscore", [40, 80, 2], "", "", True, 'price', "ema10", 80, [-2,2]]],
    "fefts_fly_ema": [["FEFc1_FEFc4"],
                      ["FEF_flyc0", "ma", [1, 2, 1], "ema5", "", True, 'price', "ema1", 80, [-2,2]]],
    "fefts_flymom_hlr": [["FEFc1_FEFc4"],
                      ["FEF_flyc0", "hlratio", [40, 80, 2], "ema5", "", True, 'price', "ema3", 80, [-2,2]]],
    "fefts_pbf_arb_ma": [["FEFc1_FEFc4"], # applicable to nmf
                         ["pbf_imp_profit", "ma", [1, 2, 1], "ema1", "", True, 'price', "ema3", 80, [-2,2]]],
    "fefts_pbf_arb_zsa": [["FEFc1_FEFc4"], # applicable to nmf/macf
                          ["pbf_imp_profit", "zscore_adj", [80, 120, 2], "ema1", "", True, 'price', "ema1", 80, [-2,2]]],
    "fefts_macf_prem_qtl": [["FEFc1_FEFc4"], # applicable to platts float/mysteel pbf/jmb/macf
                         ["macf_prem", "qtl", [120, 160, 2], "", "", True, 'price', "ema1", 80, [-2,2]]],
    "fefts_io_pinv_qtl": [["FEFc1_FEFc4"],
                         ["io_inv_imp_45ports_w", "qtl", [5, 9, 1], "", "", False, '', "ema1", 80, [-2,2]]],
    "fefts_io_pinv_cal_qtl": [["FEFc1_FEFc4"],
                              ["io_inv_imp_45ports_w", "seasonal_cal_wk_qtl", [2, 5, 10], "df1", "pct_change", False, '', "ema20", 80, [-2,2]]],
    "fefts_io_invr_hlr": [["FEFc1_FEFc4"],
                          ["io_inv_removal_ratio_41p", "hlratio", [24, 32, 1], "", "", False, '', "ema5", 80, [-2,2]]],
    "fefts_io_invr_ma": [["FEFc1_FEFc4"],
                          ["io_inv_removal_ratio_41p", "ma", [1, 2, 1], "df1", "pct_change", False, '', "ema30", 80, [-2,2]]],
    "fefts_io_invr_cal_qtl": [["FEFc1_FEFc4"],
                          ["io_inv_removal_ratio_41p", "seasonal_cal_wk_qtl", [2, 5, 10], "df1|ema3", "pct_change", False, '', "ema10", 80, [-2,2]]],
    "fefts_io_removal_hlr": [["FEFc1_FEFc4"],
                          ["io_removal_41ports", "hlratio", [48, 56, 1], "", "", True, '', "ema3", 80, [-2,2]]],
    "fefts_io_removal_lyoy_zs": [["FEFc1_FEFc4"],
                          ["io_removal_41ports", "zscore", [48, 56, 1], "lunar_yoy_day", "diff", True, '', "ema5", 80, [-2,2]]],
    "fefts_io_removal_lunar_zs": [["FEFc1_FEFc4"],
                          ["io_removal_41ports", "seasonal_lunar_wk_zs", [2, 5, 10], "", "", True, '', "ema3", 80, [-2,2]]],
    "eaf_bf_spd_zs": [["ic1_ic2"],
                      ["eaf_bf_spd", "zscore", [240, 250, 2], "", "", True, '', "sma5", 80, [-2,2]]],
    "hrc_margin_sb_zs": [["ic1_ic2"],
                         ["hrc_margin_sb", "zscore", [240, 250, 2], "", "", False, '', "", 80, [-2,2]]],
    ...
    'ni_ore_qtl': [['ni'], ['ni_ore_1.8_others_cif', 'qtl', [10, 20], '', '', True, '', "sma1", 120, [-2,2]]],
    'al_alumina_qtl': [['al'],
...
feature_to_feature_key_mapping = {
    ...
    'base_inv': {
        'cu': 'cu_sinv_cn_d', #"cu_inv_combo",
        'al': 'al_inv_social_all',
        'zn': "zn_inv_social_all",
        'ni': 'ni_sinv_27_cn', #"ni_inv27_all",
        'pb': 'pb_ingot_sinv_cn_d', #"pb_inv_social_all",
        'sn': 'sn_sinv_cn_w', #"sn_inv_social_all",
        'ao': 'ao_inv_total_cn', #'bauxite_inv_az_ports',
