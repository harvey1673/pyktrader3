...
signal_store = {
    ...
    'prop2hand_px_qtl': [['rb', 'hc'], ['prop_2ndhand_px_idx', 'qtl', [50, 55], '', '', True, "", "", 120, [-2,2]]],
    ...
    'fef_c1_c2_ratio_or_qtl': [['rb', 'hc', 'j'],
                               ['FEF_c1_c2_ratio', 'hlratio', [40, 60, 2], 'ema1', '', False, '', "", 120, [-2,2]]], #hmp0.35
    'fef_c1_c2_ratio_spd_qtl': [['rb_i', 'hc_i', 'j_i'],
                                ['FEF_c1_c2_ratio', 'qtl', [30, 60, 2], '', '', False, '', "hmp0.2", 120, [-2,2]]],
    'fef_fly_ratio_or_qtl': [['rb', 'hc', 'j'],
                             ['FEF_c123fly_ratio', 'hlratio', [40, 60, 2], 'ema1', '', False, '', "hmp0.2", 120, [-2,2]]],
    ...
    'fef_ryieldmom_spd_zs': [['rb_i', 'hc_i'],
                             ['FEF_ryield', 'zscore', [10, 80, 2], 'ema1', '', False, '', "hmp0.4", 120, [-2,2]]],
    ...
    'fef_basmom5_spd_qtl': [['rb_i', 'hc_i'],
                           ['FEF_basmom5', 'qtl', [40, 80, 2], 'ema3', '', False, 'price', "hmp0.2", 120, [-2,2]]],
    ...
    'ioarb_spd_qtl_1y': [['rb_i', 'hc_i'],
                         ['io_on_off_arb', 'qtl', [240, 260, 2], 'sma2', '', False, 'price', 'sma1', 120, [-2,2]]],

    'io_removal_lvl': [['rb', 'hc', 'i', 'j', 'jm', 'v', 'FG', 'cu'],
                       ['io_removal_41ports', 'qtl', [20, 40, 2], '', '', True, 'price', 'sma2', 120, [-2,2]]],
    'io_removal_lyoy': [['rb', 'hc', 'i', 'j', 'jm', 'v', 'FG', 'cu'],
                        ['io_removal_41ports', 'qtl', [6, 10], 'lunar_yoy_day', 'diff', True, 'W-Fri', 'sma2', 120, [-2,2]]],
    'io_inv_rmv_ratio_1y': [['i'],
                            ['io_inv_removal_ratio_41p', 'hlratio', [48, 56], 'df1', 'pct_change', False, '', "sma1", 120, [-2,2]]],
    'io_millinv_lvl': [['i'],
    ...
    'io_pinv31_lvl_zsa': [['rb_i', 'hc_i'],
                          ['io_inv_31ports', 'zscore_adj', [8, 56, 4], '', '', True, '', "sma2", 120, [-2,2]]],
    'io_pinv45_lvl_hlr': [['rb_i', 'hc_i'],
                          ['io_inv_45ports', 'hlratio', [8, 56, 4], '', '', True, '', "sma2", 120, [-2,2]]],
    # 'io_port_inv_lvl_slow': [['i'],
    #                          ['io_inv_imp_31ports_w', 'zscore', [240, 255, 5], '', '', False, 'price', "", 120, [-2,2]]],
    ...
    'rbhc_dmd_mds': [['rb-hc'],
                     ['rb_hc_dmd_diff', 'ma_dff_sgn', [5, 9, 1], '', '', True, '', "sma1", 120, [-2,2]]],
    'rbhc_dmd_lyoy_mds': [['rb-hc'],
                          ['rb_hc_dmd_diff', 'ma_dff_sgn', [5, 9, 1], 'lunar_yoy_day', 'diff', True, '', "sma1", 120, [-2,2]]],
    'rbhc_sinv_mds': [['rb-hc'],
                      ['rb_hc_sinv_diff', 'ma_dff_sgn', [5, 9, 1], '', '', False, '', "sma1", 120, [-2,2]]],
    'rbhc_sinv_lyoy_mds': [['rb-hc'],
                           ['rb_hc_sinv_diff', 'ma_dff_sgn', [5, 9, 1], 'lunar_yoy_day', 'diff', False, '', "sma1", 120, [-2,2]]],
    ...
    'hc_rb_diff_20': [['rb', 'hc', 'i', 'j', 'jm', 'cu', 'al'],
                            ['hc_rb_diff', 'zscore', [20, 40, 2], '', '', True, 'price', "buf0.4", 120, [-2,2]]],
    ...
    'metal_pbc_ema': [['i', 'rb', 'hc', 'jm', 'j', 'SM', 'SF', 'FG', 'SA', 'v', 
                      ...
                      ['metal_pbc', 'ema', [10, 20], '', '', True, 'price', "", 120, [-2,2]]],
